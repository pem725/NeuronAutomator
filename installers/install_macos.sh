...
case "$USER_SHELL" in
    zsh)
        echo "Configuring for Zsh (macOS default)..."
    ...
    fish)
        ...
        echo "Run: fish_add_path /usr/local/bin"
        ;;
    *)
...
echo ""
echo "⚠️  IMPORTANT: Please restart your terminal or run 'source ~/.${USER_SHELL}rc' to apply PATH changes"
